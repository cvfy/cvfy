          ...
          const pages = context.userData.map((el, i) => (
            ...
            >
              ...
              <div className="A4ContentWrap">
                <div className="left">
                  {el.experience[0] &&
                    context.style.leftSide.includes("experience") && (
                      <Experience index={i} />
                    )}
                  {el.education[0] &&
                    context.style.leftSide.includes("education") && (
                      <Education index={i} />
                    )}
                  {el.skills[0] &&
                    context.style.leftSide.includes("skills") && (
                      <Skills index={i} />
                    )}
                  {el.projects[0] &&
                    context.style.leftSide.includes("projects") && (
                      <Projects index={i} />
                    )}
                  {el.certifications[0] &&
                    context.style.leftSide.includes("certifications") && (
                      <Certifications index={i} />
                    )}
                  {el.achievements[0] &&
                    context.style.leftSide.includes("achievements") && (
                      <Achievements index={i} />
                    )}
                  {el.courses[0] &&
                    context.style.leftSide.includes("courses") && (
                      <Courses index={i} />
                    )}
                  {el.languages[0] && context.style.leftSide.includes("") && (
                    <Languages index={i} />
                  )}
                </div>
                <div className="right">
                  {el.experience[0] &&
                    context.style.rightSide.includes("experience") && (
                      <Experience index={i} />
                    )}
                  {el.education[0] &&
                    context.style.rightSide.includes("education") && (
                      <Education index={i} />
                    )}
                  {el.skills[0] &&
                    context.style.rightSide.includes("skills") && (
                      <Skills index={i} />
                    )}
                  {el.projects[0] &&
                    context.style.rightSide.includes("projects") && (
                      <Projects index={i} />
                    )}
                  {el.certifications[0] &&
                    context.style.rightSide.includes("certifications") && (
                      <Certifications index={i} />
                    )}
                  {el.achievements[0] &&
                    context.style.rightSide.includes("achievements") && (
                      <Achievements index={i} />
                    )}
                  {el.courses[0] &&
                    context.style.rightSide.includes("courses") && (
                      <Courses index={i} />
                    )}
                  {el.languages[0] &&
                    context.style.rightSide.includes("languages") && (
                      <Languages index={i} />
                    )}
                </div>
              </div>
